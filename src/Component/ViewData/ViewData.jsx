  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      <table className="min-w-full table-auto border-collapse border border-gray-300">
        <thead>
          <tr className="bg-red-200 text-black-600 uppercase text-sm leading-normal">
            <th className="px-4 py-2 border border-gary-300">#</th>
        ...
        <tbody>
          {Storage.map((rec, index) => (
            <tr key={index} className="bg-white hover:bg-gray-100 text-black-600 text-blod">
